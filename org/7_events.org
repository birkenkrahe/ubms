...
4) Press the SPACE bar to start the three concurrent actions.

* TODO Assignment: Bird/Ball
...
the program does what it should). Great opportunity to make up for bad
quiz scores!
