...
- Colab notebook for the Guess-the-Number game: [[https://tinyurl.com/guessUBMS][tinyurl.com/guessUBMS]]

- Links to explore making games in Python:

  1) Al Sweigart's "Invent your own computer games with Python" (4e),
     2016 - URL: [[https://inventwithpython.com/invent4thed/][inventwithpython.com]].
  ...
  3) Turtle is the built-in graphics and gaming library. There are
     ...
     [[https://www.freecodecamp.org/news/how-to-make-racing-game-using-python/][Racing game]] (this is the shortest and best for starters).
