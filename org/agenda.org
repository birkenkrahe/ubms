...
- Ranking of Programming Languages: TIOBE Index
- How many programming languages there are
...
- You can also add the local copy of ~Snap!~ but you have to do this
  manually via the File Explorer.
