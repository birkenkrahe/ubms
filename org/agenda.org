...
- [[https://lyon.instructure.com/courses/1721/assignments/14944][Exercise: "Soundbites"]] (Upload URL to cloud location)

- Submit completed exercises (as URLs) in Canvas no later than 10 pm!

* Quiz 1 and quiz 2 results

#+begin_src R :results output graphics file :file ../img/q1.png
  q1 <- c(7.25,9.5,9.25,7.25,9,9.25,8.25,8.5,8,8.5,8.5,8.25)
...
#+begin_src R :results output graphics file :file ../img/q2.png
  q2 <- c(4.5,7.5,4.25,6.75,2,8.5,6,5.75,7.25,6.5,5.75)
  par(mfrow=c(2,1),pty='s')
  hist(q2)
  boxplot(q2,horizontal=TRUE)
#+end_src
