...
* TODO Cat-and-mouse and Game of maze (June 28)
#+attr_latex: :width 400px
[[../img/maze.png]]
...
- Wait until and keyboard events (polling)
- Maze game (guided implementation)

* More games?

- My students have created cool, working arcade games in Snap!: Donkey
  Kong, Asteroids, Space Invaders and Pacman. Links are
  [[https://docs.google.com/presentation/d/1f_1z4V1_tZ8PPGPil0WEUKGasgpf0jB-/edit?usp=sharing&ouid=102963037093118135110&rtpof=true&sd=true][in this presentation]].

- This [[https://www.youtube.com/watch?v=5sUpqyDgFMo][brick breaker game tutorial (30 min)]] is in Scratch, but you can
  re-engineer it for Snap!

- This [[https://youtu.be/MAjobdDNqKY][platformer game tutorial (30 min)]] is in Scratch, but you can
  re-engineer it for Snap!

* TODO From Snap! to Python (June 29)
#+attr_latex: :width 400px
...
- Project game of bricks (guided implementation)
- Summary and outlook
