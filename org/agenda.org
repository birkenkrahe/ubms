...
* Broadcasting and storytelling (June-20)
#+attr_html: :width 400px
[[../img/highground.png]]
...
* Story presentations, events (June-21)
#+attr_html: :width 400px
[[../img/s6_keyboard.jpg]]
...
- Continue your story animation project until 10:10 AM.
- At 10:10 AM we'll look at all projects and critique them.
- We'll continue with "events", "effects" and "concurrency".
- There will be another quiz tomorrow!
  
* Conditional statements, Keyboard input (June 22)
* Project: helicopter (June-23)
* Next week: maze game, variables and stuff
* Week after: robotics
