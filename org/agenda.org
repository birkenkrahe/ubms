...
* TODO Snap! & Python: Guessing Game (June 30)
...
- Links to explore making games in Python:
  ...
  1) Al Sweigart's free book "Invent your own computer games with
     Python" (4e), 2016 contains games. URL: [[https://inventwithpython.com/invent4thed/][inventwithpython.com]].
  ...
  (that's what I use though IDLE is just as good).
...
5) Which Python functions do you already know?
   ...
   #+end_quote   
* Exercise: explore/plot baby names data (15 min)

- Open yesterday's Colab Demo file and transfer the answers from there
...
- Time: 20 minutes - followed by post-mortem.
...
* Demo: Ball and paddle game in Python (30 min)
...
* July 10-13: Robotics (Snap! and Python)
#+attr_latex: :width 400px
